...
def safetyProjection(selectedMesh):
	...
	if cmds.optionVar(q="QU_SafetyProjectionAxis") == 1:
		...
		print "Placeholder for potential custom axis projection, defaults to Z axis for now."
		axis = 'z'
...
def orientationStep(selectedMesh):
	print "Shell orientation is currently not functional.  Should be between 1 and 2 of 2 for Layout Process."

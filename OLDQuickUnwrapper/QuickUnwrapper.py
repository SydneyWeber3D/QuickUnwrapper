...
def makeShelfButton():
    ...
    cmds.shelfButton(ann="Quick Unwrap",c=(lambda : runUnwrap()),dcc=(lambda : quWindow()),h=34,w=34,i=shelfIcon,mi=("Auto Smooth", "python(\"TestScript2.AutoSmooth()\");"),l="Quick Unwrap",p=shelfLocation,stp="python",st="iconOnly")
...
def quWindow():
    ...
    cmds.button(l="Unwrap",w=90,h=30,c=(lambda _: makeShelfButton()))
    cmds.button(l="Cancel",w=90,h=30,c=("deleteUI(\"quWindow\",window=True)"))
    cmds.setParent("quContainer")
